...
import { Text, TouchableOpacity, View, Image, ImageBackground, TextInput, Button, SafeAreaView, ScrollView } from 'react-native';
import styles from '../style/styles';
import {check_num, check_password} from '../utilitaires/check';
...
export default function LoginScreen({route}) {
  ...
  const inscription = ()=>{
    navigation.navigate('Inscription', {user})
  }
